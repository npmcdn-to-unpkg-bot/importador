System.register(['angular2/core', 'angular2/common', 'angular2/router', './lang.service', './jsandoc-core', './doc.service', './user.service', './jsandoc-section.component'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            JsandocSharedComponent = (function (_super) {
                __extends(JsandocSharedComponent, _super);
                function JsandocSharedComponent(_langService, _docService, _userService, _router, _routeParams) {
                ...
                return JsandocSharedComponent;
            }(jsandoc_core_1.JsandocCore));
            exports_1("JsandocSharedComponent", JsandocSharedComponent);
        }
    }
});
