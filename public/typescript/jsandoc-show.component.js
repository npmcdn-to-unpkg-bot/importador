System.register(['angular2/core', 'angular2/common', 'angular2/router', './lang.service', './jsandoc-core', './doc.service', './user.service', './jsandoc-section.component'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            JsandocShowComponent = (function (_super) {
                __extends(JsandocShowComponent, _super);
                function JsandocShowComponent(_langService, _docService, _userService, _router, _routeParams) {
                ...
                JsandocShowComponent = __decorate([
                    core_1.Component({
                ...
                return JsandocShowComponent;
            }(jsandoc_core_1.JsandocCore));
            exports_1("JsandocShowComponent", JsandocShowComponent);
        }
    }
});
